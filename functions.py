...
actions = np.array(['wait','ขอโทษที่มาสาย','คุณชื่ออะไร','คุณสบายดีไหม','ฉันสบายดี','แล้วพบกันใหม่',
                    ...
                    'คุณทำงานอะไร','ฉันทำงานเป็นช่างทำผม','ฉันทำงานเป็นคนขับรถแท็กซี่','เมื่อวานไปไหนมา',
                    'ฉันหิวข้าว','เมื่อวานฉันไปเที่ยว','ฉันไปหาหมอ','เดินตรงไป','เลี้ยวซ้าย','เลี้ยวขวา', 
                    'เดินไปข้างหน้า', 'วันนี้อากาศดี', 'สถานีรถไฟไปทางไหน','ต้องเดินอีกไกลไหม', 'วันนี้ฉันตื่นสาย'])
